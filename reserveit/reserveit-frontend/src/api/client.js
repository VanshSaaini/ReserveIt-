...
export const clinicApi = {
  ...
  subscription: () => get('/api/clinic/subscription'),
  subscriptionPlans: () => get('/api/clinic/subscription/plans'),
  subscriptionHistory: () => get('/api/clinic/subscription/history'),
...
export const adminApi = {
  ...
  subscriptionPlans: () => get('/api/admin/subscription-plans'),
